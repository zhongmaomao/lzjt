...
class Console(object):
    ...
    def __init__(self,model_path="model/word2vec_model.model",
    ...
    def write_output(self, org_speech, result, path, output = None):
        ...
        result_information += "-----------------------\n"
        result_information += 'Sim' + '\t\t' + 'Domain' + '\t' + 'Word' + '\n'
        result_information += "-----------------------\n"
        for similarity,rule,matchee in result:
            str_sim = '%.4f' % similarity
            result_information += str_sim+'\t'+rule+'\t\t'+matchee+'\n'
        result_information += "-----------------------\n"
